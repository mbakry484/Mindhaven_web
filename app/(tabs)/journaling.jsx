...
const JournalingScreen = () => {
    ...
    const loadEntries = async () => {
        try {
            ...
            const response = await fetch(`http://108.181.218.68:8000/api/get_journal_entries/${userId}/`);
            if (!response.ok) {
    ...
    const saveEntry = async () => {
        ...
        try {
            const userId = await AsyncStorage.getItem('user_id');
            const response = await fetch('http://108.181.218.68:8000/api/add_journal_entry/', {
                method: 'POST',
                headers: {
    ...
    const updateEntry = async () => {
        ...
        try {
            const response = await fetch(`http://108.181.218.68:8000/api/update_journal_entry/${editingEntry._id}/`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const deleteEntry = async (entryId) => {
        try {
            const response = await fetch(`http://108.181.218.68:8000/api/delete_journal_entry/${entryId}/`, {
                method: 'DELETE',
            });
