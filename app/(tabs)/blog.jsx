      ...
      {!isExpanded ? (
        ...
        <View style={styles.createPostExpanded}>
          <View style={styles.createPostHeader}>
            <View style={styles.createPostHeaderLeft}>
              <Text style={styles.createPostTitle}>{t('blog.create_post')}</Text>
            </View>
            <View style={styles.createPostHeaderRight}>
              <TouchableOpacity 
                style={[
                  styles.postButton,
              ...
              >
                <Text style={[
                  ...
                  (!title.trim() || !content.trim()) && styles.postButtonTextDisabled
                ]}>{t('blog.post')}</Text>
              </TouchableOpacity>
              <TouchableOpacity 
                onPress={() => {
